...
const Drafts = () => {
    ...
    document.title = `Drafts - Gmail Clone`

    const dispatch = useDispatch()

    dispatch(inputvalue({ inputValue: 'in:draft' }))
    ...
    return (
        <div className='Draft__container' style={quickSetting.value ? { width: "912px" } : { width: "80%" }}>
            <div className="DraftSticky_top">
                <div className="bottom_icons">
                    <div className="icons_section">
                        <div className="iconSection_left">
                            ...
                            <div className={showMorePopup ? "morePopupDrafts moreopts" : "morePopupDrafts lessopts"}>
                        ...
                        <div className="iconSection_right">
                            ...
                            <div className={showSplitPanePopup ? "splitPanemode_popupDrafts moreopts" : "splitPanemode_popupDrafts lessopts"}>
                                <p>No split</p>
                                <p>Vertical split</p>
                ...
                <div className="draftText_title">
                    <p>You don't have any saved drafts.<br />
                        Saving a draft allows you to keep a message you aren't ready to send yet.</p>
                </div>
            </div>
        </div>
    )
