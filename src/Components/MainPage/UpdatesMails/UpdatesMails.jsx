...
const UpdatesMails = () => {
    ...
    document.title = `Updates (${context.inboxMails.length}) - Gmail Clone`
    ...
    dispatch(inputvalue({ inputValue: 'category:updates' }))
    ...
    const handleMarkAllAsRead = async () => {
        ...
        setShowMorePopup(false)
        axios.put(`${config.api}/main/updateMarkAsReadAll`, { collectionName })
    ...
    useEffect(() => {
        let Updates = async () => {
            try {
                dispatch(loadingtext({ isLoading: true }))
                let fetchUpdatesMails = await axios.get(`${config.api}/main/inbox/${inboxSortValue}`)
                context.setInboxMails(fetchUpdatesMails.data)
                dispatch(loadingtext({ isLoading: false }))
            } catch (error) {
                console.log(error);
            }
    ...
    return (
        <div className='updates__container' style={quickSetting.value ? { width: "912px" } : { width: "80%" }}>
                ...
                <div className="bottom_icons">
                    <div className="icons_section">
                        <div className="iconSection_left">
                            ...
                            <div className={showMorePopup ? "morePopupUpdates moreopts" : "morePopupUpdates lessopts"}>
                        ...
                        <div className="iconSection_right">
                            ...
                            <div className={showNewestOldestPopup ? "newestOlder_popupUpdates moreopts" : "newestOlder_popupUpdates lessopts"}>
                            ...
                            <div className={showSplitPanePopup ? "splitPanemode_popupUpdates moreopts" : "splitPanemode_popupUpdates lessopts"}>
                                <p>No split</p>
                                <p>Vertical split</p>
            ...
            <div className="Updates_mailCard_container">
                {
