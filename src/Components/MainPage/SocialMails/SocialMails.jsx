...
const SocialMails = () => {
    ...
    document.title = `Social (${context.socialMails.length}) - Gmail Clone`
    ...
    dispatch(inputvalue({ inputValue: 'category:social' }))
    ...
    if (params.socialmails == ":socialmails") {
    ...
    useEffect(() => {
        let SocialMails = async () => {
            try {
                dispatch(loadingtext({ isLoading: true }))
                let fetchSocialMails = await axios.get(`${config.api}/main/social/${inboxSortValue}`)
                context.setSocialMails(fetchSocialMails.data)
                dispatch(loadingtext({ isLoading: false }))
            } catch (error) {
                console.log(error);
            }
    ...
    return (
        <div className='socialMails__container' style={quickSetting.value ? { width: "912px" } : { width: "80%" }}>
                ...
                <div className="bottom_icons">
                    <div className="icons_section">
                        <div className="iconSection_left">
                            ...
                            <div className={showMorePopup ? "morePopupSocialMails moreopts" : "morePopupSocialMails lessopts"}>
                        ...
                        <div className="iconSection_right">
                            ...
                            <div className={showNewestOldestPopup ? "newestOlder_popupSocialMails moreopts" : "newestOlder_popupSocialMails lessopts"}>
                            ...
                            <div className={showSplitPanePopup ? "splitPanemode_popupSocialMails moreopts" : "splitPanemode_popupSocialMails lessopts"}>
                                <p>No split</p>
                                <p>Vertical split</p>
            ...
            <div className="socialMails_mailCard_container">
                {
                    filteredMails.map((social) => {
                        return <MailCard social={social} key={social._id} />
                    })
                }
            </div>
        </div>
