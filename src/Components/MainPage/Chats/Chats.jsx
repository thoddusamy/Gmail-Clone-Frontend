...
const Chats = () => {
    ...
    document.title = `Chats - Gmail Clone`

    const dispatch = useDispatch()

    dispatch(inputvalue({ inputValue: 'in:chats' }))
    ...
    return (
        <div className='chats__container' style={quickSetting.value ? { width: "912px" } : { width: "80%" }}>
            <div className="ChatsSticky_top">
                <div className="bottom_icons">
                    <div className="icons_section">
                        <div className="iconSection_left">
                            ...
                            <div className={showMorePopup ? "morePopupChat moreopts" : "morePopupChat lessopts"}>
                        ...
                        <div className="iconSection_right">
                            ...
                            <div className={showSplitPanePopup ? "splitPanemode_popupChat moreopts" : "splitPanemode_popupChat lessopts"}>
                                <p>No split</p>
                                <p>Vertical split</p>
